...
public class FollowAndFlip : MonoBehaviour
{
    ...
    public float horizontalOffset = -0.5f; // negative = behind


    private bool  isFollowing    = false;
    private float originalScaleX;
    [Header("Key Bindings")]
    public KeyCode followToggleKey = KeyCode.B;
    ...
    void FollowLuna()
    {
        ...
        Vector3 goal = target.position + new Vector3(horizontalOffset, followDistance, 0f);
