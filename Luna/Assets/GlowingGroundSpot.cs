...
public class GlowingGroundSpot : MonoBehaviour
{
    ...
    {
        if (flowerPrefab != null && spawnPoint != null)
        {
            var flower = Instantiate(flowerPrefab, spawnPoint.position, Quaternion.identity);
        }
