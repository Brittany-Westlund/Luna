...
public class ActivateFlowerSwayAndLightOnMaxScale : MonoBehaviour
{
    ...
    public FlowerSway flowerSwayScript; // Reference to the FlowerSway script component
    public LightFadeActivation lightFadeActivationScript; // Reference to the LightFadeActivation script component
