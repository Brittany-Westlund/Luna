...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
        GameObject sp = _spore.CreateSpore();   // grab the instance
        ExtendFlight();
        StartCoroutine(DestroySporeAfterDelay(sp, 0.5f));
        }
    ...
    IEnumerator DestroySporeAfterDelay(GameObject spore, float delay)
    {
