...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    public GameObject lunaInFlight;                 // Flying Luna GameObject (child of butterfly)
    ...
    [HideInInspector]
    public bool justDismounted = false;              // Flag to signal a recent dismount
    ...
    public Transform flowerHoldPoint;               // Ground flower attach
    public Transform flightFlowerHoldPoint;         // Flight flower attach
    ...
    private Transform _flightOriginalParent;        // original parent of lunaInFlight
    ...
    void Start()
    {
        ...
        // Cache original parent of flight sprite
        _flightOriginalParent = lunaInFlight.transform.parent;

        // Initial state: only ground Luna visible
        luna.SetActive(true);
    ...
    void Mount()
    {
        ...
        // Show flight Luna and parent it to butterfly
    ...
    {
        // Show ground Luna and restore parent of flight sprite
        lunaInFlight.SetActive(false);
        lunaInFlight.transform.SetParent(_flightOriginalParent, false);
        luna.SetActive(true);
