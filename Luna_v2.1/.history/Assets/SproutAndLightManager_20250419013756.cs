...
public class SproutAndLightManager : MonoBehaviour
{
    ...
    void Awake()
    {
        // Remember whatever scale the flower prefab started with:
        _baseScale = transform.localScale;
        // DON'T override it to growthIncrement here.
    ...
    void ShowSporeHint()
    {
        if (_sporeHintActive || sporeHintPrefab == null || _currentStage >= maxGrowthStages)
            return;

        Debug.Log($"[Sprout] Showing spore hint at stage {_currentStage}");
