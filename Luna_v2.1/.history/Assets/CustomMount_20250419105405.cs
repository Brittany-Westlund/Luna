...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    public int   teaRosePollenCount   = 0;    // How many toward permanent boost
    public float speedBoostPerPollen  = 1f;
    public int   pollenThreshold      = 3;

    // Required by LunaSporeSystem’s justDismounted check
    ...
    void Start()
    {
        ...
        // Gather every collider we’ll toggle
        ...
        // Initialize spore attach point
        sporeSystem.attachPoint = sporeHoldPoint;

        // Initial visual/physics state
    ...
    void Update()
    {
        // F = mount / extend flight / dismount
        ...
        // When flying, handle movement & actions
        if (isFlying)
        {
            ...
            // R is handled by LunaSporeSystem itself
        }
    }
    ...
    private void Mount()
    {
        ...
        // Disable physics bumps: make every collider a trigger
        foreach (var c in allColliders)
            c.isTrigger = true;
        ...
        // Sync facing from Luna’s own scale.x
    ...
    /// <summary>
    /// Called by TeaRosePollenPickup to apply permanent pollen speed boosts.
    /// </summary>
