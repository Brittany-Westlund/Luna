...
{
    [Header("References")]
    public GameObject luna;                   // your main Luna object (with spore & flower scripts)
    public GameObject lunaInFlight;           // the in‐flight sprite parented to butterfly
    ...
    public float bonusSpeed      = 0f;       // permanent pollen boost
    public float jumpForce       = 5f;       // impulse on space‐dismount
    ...
    void Start()
    {
        ...
        // assume the ground sprite is on the root of "luna"
    ...
    void Update()
    {
        ...
        // R: if carrying a spore, extend flight
    ...
    private void Mount()
    {
        ...
        // keep Luna active so sporeSystem still works
        if (lunaGroundSprite != null) 
    ...
    private void Dismount(bool jumpOff)
    {
        ...
        // restore gravity & clear velocity
        if (lunaRb != null)
        {
