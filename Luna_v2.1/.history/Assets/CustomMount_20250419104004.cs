...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    public GameObject lunaInFlight;           // flight‐sprite parented under butterfly
    ...
    public float jumpForce       = 5f;       // impulse when pressing Space
    ...
    public Transform groundSporeAttachPoint; // set this in Inspector
    public Transform flightSporeAttachPoint; // set this in Inspector (child of lunaInFlight)
    ...
    void Start()
    {
        ...
        // match the inspector‐set ground attach point
    ...
    void Update()
    {
        ...
        // R to extend flight if carrying a spore
    ...
    private void Mount()
    {
        // hide ground sprite, show flight sprite
        lunaGroundSprite.enabled = false;
        lunaInFlight.SetActive(true);

        // move spore attach point to flight mount
        sporeSystem.attachPoint = flightSporeAttachPoint;

        // disable all colliders (butterfly + Luna ground + Luna flight)
        ...
        // sync facing: read Luna’s localScale.x
    ...
    {
        // hide flight sprite, show ground sprite
        lunaInFlight.SetActive(false);
        lunaGroundSprite.enabled = true;
