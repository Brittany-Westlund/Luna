...
{
    [Header("References")]
    public GameObject luna;                   // Luna root (with spore + flower scripts)
    public GameObject lunaInFlight;           // Flight‐mode sprite parented to butterfly
    ...
    public Transform groundSporeAttachPoint; // assign to your ground attach in Inspector
    ...
    void Start()
    {
        ...
        // ensure groundSporeAttachPoint matches your spore system
    ...
    private void Mount()
    {
        ...
        // disable Luna colliders so she doesn't push the butterfly
        ...
        ls.x = butterflyRenderer.flipX ? -Mathf.Abs(ls.x) : Mathf.Abs(ls.x);
    ...
    private void HandleButterflyMovement(float speed)
    {
        ...
        if (Mathf.Abs(hx) < 0.01f)
        {
            ...
            if (Input.GetKey(KeyCode.D)||Input.GetKey(KeyCode.RightArrow)) hx =  1;
        }
