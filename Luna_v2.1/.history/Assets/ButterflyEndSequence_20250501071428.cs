...
public class ButterflyEndSequence : MonoBehaviour
{
    ...
    [Header("Dialogue")]
    public GameObject dialogueTriggerObject; // Auto-triggered when butterfly reaches Luna
    ...
    void TriggerDialogue()
    {
        ...
        {
            dialogueTriggerObject.SetActive(true); // Assumes it triggers dialogue on enable
