...
public class SproutAndLightManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 🔄 Fallback auto-assign for scene-placed flowers
        if (LightBar == null)
        {
        ...
        {
            Debug.LogWarning($"[SproutAndLightManager] {gameObject.name} missing LightBar or ScoreManager.Instance. Did you forget Setup()?");
        }
    ...
    public void Setup(MMProgressBar lightBar, Transform playerTransform)
    {
        LightBar = lightBar;
