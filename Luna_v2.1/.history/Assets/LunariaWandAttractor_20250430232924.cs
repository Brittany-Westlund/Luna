...
public class LunariaWandAttractor : MonoBehaviour
{
    ...
    [Header("Parent Container (e.g., ScaledLuna)")]
    public Transform lunaRoot;
    ...
    IEnumerator PopScale(Transform obj, float popScale, float duration)
    {
    ...
    private void DropWand()
    {
        ...
        if (lunaRoot != null)
            transform.position = lunaRoot.position + Vector3.up * 0.2f;  // ✅ Use world position of the true parent
        else if (_luna != null)
