...
public class TeapotReceiver : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            // Only adds flowers; retrieval is driven by FlowerInteraction now
    ...
    /// <summary>
    /// Hides the held flower, stacks it, shows its icon, and drops it from the holder.
    /// </summary>
    ...
    /// <summary>
    /// Pops the last‑added flower off the pot and gives it back to the specified holder.
    /// </summary>
