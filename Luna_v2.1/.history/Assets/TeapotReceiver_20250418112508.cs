...
public class TeapotReceiver : MonoBehaviour
{
    ...
    /// <summary>
    /// Called by FlowerInteraction to add the holder’s flower into the pot.
    /// </summary>
    ...
    /// <summary>
    /// Called by FlowerInteraction to pull back the last‐added flower.
    /// </summary>
    public void RetrieveLastFlower()
    {
        if (storedFlowerObjects.Count == 0) return;
