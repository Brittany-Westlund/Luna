...
public class TeaStateManager : MonoBehaviour
{
    ...
    private Transform  teapotSpawnPoint;
    public KeyCode    teaKey = KeyCode.T;
    public float lilyStoolSearchRadius = 2f; // How close you need to be to a lilystool to spawn a teapot
    ...
    void HandleTeaLogic()
    {
        ...
        if (_currentTeapot == null)
        {
            ...
            if (nearest == null)
            {
                ...
                // Optional: Play a denied SFX or flash a UI hint
                return;
            }
