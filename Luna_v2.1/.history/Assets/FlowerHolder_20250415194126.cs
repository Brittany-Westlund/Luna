...
public class FlowerHolder : MonoBehaviour
{
    ...
    public void PickUpFlowerInstance(GameObject flower)
    {
        ...
        if (heldPivot == null)
        {
            Debug.LogError("❌ Flower is missing a 'pivot' child: " + flower.name);
            return;
        }
        ...
        heldFlower.transform.position = holdPoint.position + offset;

        heldFlower.transform.SetParent(holdPoint, true);
    }
