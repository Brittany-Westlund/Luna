...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    [Tooltip("Speed of the butterfly's flying animation")]
    public float animationSpeedFlying = 2f;
    [Tooltip("Speed of the butterfly's normal animation")]
    public float animationSpeedNormal = 1f;

    [Header("Movement & Jump")]
    public float baseSpeed     = 2.2f;
    public float bonusSpeed    = 0f;
    public float jumpForce     = 5f;    // how hard Luna jumps off
    [Tooltip("Offset for dismount placement")]
    ...
    void Update()
    {
        ...
        if (isFlying)
        {
            float moveSpeed = baseSpeed + bonusSpeed;
    ...
    private void Mount()
    {
        // hide ground-Luna, show flight-Luna
