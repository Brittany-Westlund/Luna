...
public class TeaStateManager : MonoBehaviour
{
    ...
    void HandleTeaLogic()
    {   
       // Only highlight when we're about to deliver a teacup
        if (highlightCoroutine != null) StopCoroutine(highlightCoroutine);
        highlightCoroutine = StartCoroutine(HighlightDrinkTarget());
    ...
    private IEnumerator HighlightDrinkTarget()
    {
        ...
        if (npc != null)
        {
            ...
            yield return new WaitForSeconds(1f); // Or however long
