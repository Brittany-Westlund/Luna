...
public class TeacupReceiver : MonoBehaviour
{
    ...
    public void ReceiveTeacup(GameObject teacup)
    {
        ...
        // teacup is the GameObject reference to the teacup
        var dialogueTriggerScript = teacup.GetComponent<TeacupNPCDialogueTrigger>();
        if (dialogueTriggerScript != null)
            dialogueTriggerScript.TriggerNPCDrink();
