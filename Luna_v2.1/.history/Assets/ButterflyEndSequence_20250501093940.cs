...
using System.Collections; // Only needed if you're using DST
...
public class ButterflyEndSequence : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (restHintIcon != null) restHintIcon.SetActive(false);
    ...
    void StartSequence()
    {
        ...
        if (restHintIcon != null)
            restHintIcon.SetActive(true);  // <- put it here before coroutines
    ...
    {
        if (col.CompareTag("Garden") && restHintIcon != null)
        {
