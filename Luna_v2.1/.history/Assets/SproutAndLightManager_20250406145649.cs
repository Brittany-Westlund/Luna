...
public class SproutAndLightManager : MonoBehaviour
{
    ...
    {
        if (spore1Renderer != target) SetAlpha(spore1Renderer, 0f);
        if (spore2Renderer != target) SetAlpha(spore2Renderer, 0f);
        if (spore3Renderer != target) SetAlpha(spore3Renderer, 0f);
