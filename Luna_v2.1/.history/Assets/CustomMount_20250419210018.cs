...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    void HandleFacing()
    {
        ...
        butterfly.localScale = new Vector3(_butterflyOrigScale.x * sign, _butterflyOrigScale.y, _butterflyOrigScale.z);
        lunaInFlight.transform.localScale = new Vector3(_lunaOrigScale.x * sign, _lunaOrigScale.y, _lunaOrigScale.z);
    }
