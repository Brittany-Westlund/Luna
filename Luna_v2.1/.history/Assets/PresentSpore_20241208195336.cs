...
public class PresentSpore : MonoBehaviour
{
    ...
    private WildSporePickup wildSporePickup; // Reference to WildSporePickup
    ...
    void Update()
    {
        ...
        {
            // Prevent attaching if a wild spore is being held
            if (wildSporePickup != null && wildSporePickup.IsHoldingSpore())
            {
                Debug.Log("Cannot attach a new spore while holding a WildSpore.");
                return;
            }
