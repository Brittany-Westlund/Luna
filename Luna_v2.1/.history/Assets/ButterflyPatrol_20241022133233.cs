    ...
    void JumpOff()
{
    if (luna != null)
    {
        ...
        // Reset Luna's local scale to make sure her movement controls are not flipped
        luna.localScale = new Vector3(Mathf.Abs(luna.localScale.x), luna.localScale.y, luna.localScale.z);
