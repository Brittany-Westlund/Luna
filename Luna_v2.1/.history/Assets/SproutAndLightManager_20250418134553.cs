...
public class SproutAndLightManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var lit = transform.FindDeepChild("LitFlowerB");
        if (lit != null) LitRenderer = lit.GetComponent<SpriteRenderer>();
    ...
    void Update()
    {
        // suspend growth/hints if held or planted
...
// Helper to find deep child by name:
public static class TransformExtensions
{
    public static Transform FindDeepChild(this Transform parent, string name)
    {
        foreach (Transform c in parent)
        {
            ...
            var found = c.FindDeepChild(name);
