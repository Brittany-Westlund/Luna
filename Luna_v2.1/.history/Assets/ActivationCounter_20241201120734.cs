...
public class ActivationCounter : MonoBehaviour
{
    ...
    private IEnumerator IncrementOnce()
    {
        ...
        {
            Debug.LogError("Variable name is not set. Increment cannot proceed.");
            yield break;
        }
        ...
        // Optional: Debug log in debug builds
        if (Debug.isDebugBuild)
        {
            Debug.Log($"Incremented {variableName} by {incrementAmount}. New {variableName} value: {newCount}");
        }
    }
