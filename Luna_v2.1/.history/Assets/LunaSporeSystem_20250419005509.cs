...
public class LunaSporeSystem : MonoBehaviour
{
    ...
    // === RESTORED FOR CUSTOMMOUNT COMPATIBILITY ===

    /// <summary>Called by CustomMount to prevent health gain on detach.</summary>
    public void SetHealthLock(bool state)
    {
        healthLocked = state;
    }

    /// <summary>Called by CustomMount to fully wipe any attached spore and reset sliding.</summary>
    ...
    /// <summary>Alias of ResetSporeState for clarity.</summary>
    public void DestroyActiveSpore()
    {
        ResetSporeState();
    }
}
