...
public class FlowerHolder : MonoBehaviour
{
    ...
    [Tooltip("What scale the flower visuals should appear when held.")]
    public Vector3 heldVisualScale = new Vector3(0.3f, 0.3f, 0.3f);
