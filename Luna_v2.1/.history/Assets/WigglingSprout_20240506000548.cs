...
public class FadingSprout : MonoBehaviour
{
    ...
    public Watering wateringScript; // Reference to the Watering script
    ...
    void Update()
    {
        ...
        if (wateringScript != null && Time.time >= wateringScript.lastWaterTime + wateringScript.waterCooldown)
        {
