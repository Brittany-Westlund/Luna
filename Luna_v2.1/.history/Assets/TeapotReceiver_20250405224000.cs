   ...
   private void Start()
    {
        ...
        {
            Debug.LogWarning("☕ Brew icon not found in IconDisplay!");
        }
    }
    ...
    public void ReceiveLight()
    {
        ...
        UpdateBrewIcon(); // Show brew icon if applicable
    ...
    private void UpdateBrewIcon()
    {
        if (brewIcon != null)
        {
            brewIcon.SetActive(hasLight); // Show icon only if light is present
        }
    }
}
