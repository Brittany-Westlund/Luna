...
public class TeapotReceiver : MonoBehaviour
{
    ...
    private void Update()
    {
        // Only proceed if a valid holder is nearby
        ...
        if (Input.GetKeyDown(KeyCode.X))
        {
            ...
            else if (storedFlowerObjects.Count > 0)
            {
                ...
                if (flower != null && nearbyHolder != null)
                {
                    ...
                    if (nearbyHolder.holdPoint != null)
                    {
    ...
    public GameObject BrewTea()
    {
        ...
        {
            Debug.LogWarning("❌ No ingredients in teapot.");
            return null;
        }
        ...
        if (effect != null)
        {
            effect.SetIngredients(teaIngredients, true); // assume light always present
        }
