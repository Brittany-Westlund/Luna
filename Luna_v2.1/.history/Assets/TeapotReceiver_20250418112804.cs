...
public class TeapotReceiver : MonoBehaviour
{
    ...
    // Exposed so FlowerInteraction can detect when we're in range
    ...
    /// <summary>
    /// Called by FlowerInteraction when X is pressed while holding a flower in range.
    /// </summary>
    ...
    /// <summary>
    /// Called by FlowerInteraction if you ever want to pull back the last flower.
    /// </summary>
    public void RetrieveLastFlower()
    {
        ...
        if (flower != null && nearbyHolder != null)
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        // Detect the player’s FlowerHolder
    ...
    /// <summary>
    /// Exposed so external wand scripts can trigger charging as well.
    /// </summary>
