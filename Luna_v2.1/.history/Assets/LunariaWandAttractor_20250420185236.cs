...
public class LunariaWandAttractor : MonoBehaviour
{
    ...
    /// <summary>
    /// Called by external code (e.g. your icon script) to toggle pick‑up/drop
    /// exactly the same as pressing V in Update().
    /// </summary>
    ...
    /// <summary>
    /// Called by other systems (like your TeapotLightReceiver) to transfer the held mote.
    /// Returns true if there was a mote to give.
    /// </summary>
    public bool GiveLightToObject()
    {
        ...
        hasLight = false;
        ResetWandVisuals();
        Debug.Log("✨ Light given to object");
        return true;
    }

        /// <summary>
    /// Exposes whether the wand is currently held.
    /// </summary>
    public bool IsHeld => isHeld;

    /// <summary>
    /// Forces the wand to pick up or drop, bypassing the canPickup check.
    /// </summary>
