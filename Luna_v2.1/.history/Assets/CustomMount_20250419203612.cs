...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    public GameObject lunaInFlight;                // Separate flying Luna sprite (child of butterfly)
    ...
    void Mount()
    {
        ...
        // Swap Luna visuals by enabling the flight GameObject
    ...
    {
        // Swap back visuals by disabling the flight GameObject
        lunaInFlight.SetActive(false);
        groundLunaRenderer.enabled = true;
