...
public class SproutAndLightManager : MonoBehaviour
{
    ...
    public Vector3[]   hintOffsets;    // size = maxGrowthStages
    public float[]     hintScales;     // size = maxGrowthStages
    ...
    // Static holders so only one icon globally
    ...
    IEnumerator GrowStage()
    {
        ...
        // If fully grown, spawn light hint (hidden until re-enter)
