...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    public int   teaRosePollenCount   = 0;    // how many collected toward permanent boost
    ...
    void Start()
    {
        ...
        // gather all colliders we’ll toggle
        ...
        // point SporeSystem at Luna’s hold point initially
    ...
    void Update()
    {
        ...
        // R still calls through LunaSporeSystem for create/aid/detach
    ...
    private void Mount()
    {
        ...
        // switch spore attach point
        sporeSystem.attachPoint = flightSporeAttachPoint;

        // turn every collider into a trigger to prevent physics push
        foreach (var c in allColliders)
            c.isTrigger = true;
