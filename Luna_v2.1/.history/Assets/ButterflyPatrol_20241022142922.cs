...
public class ButterflyPatrol : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isLunaAttached && luna != null)
        {
            ...
            // If Luna moves or jumps, detach her
            if (!IsLunaIdle() || Input.GetButtonDown("Player1_Jump")) // Use "Player1_Jump" as the input for jumping
            {
                DetachLuna();
            }
        }
    ...
    void UpdateFacingDirection()
    {
        ...
        {
            spriteRenderer.flipX = !patrollingRight; // Only flip the sprite visually
        }
    }
