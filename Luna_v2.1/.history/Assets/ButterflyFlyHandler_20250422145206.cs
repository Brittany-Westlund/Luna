...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    void Mount()
    {
       ...
       // ─── MOVE ANEMONE POLLEN TO FLIGHT ────────────────────────
        ...
        else if (anemonePollenFlightHoldPoint.childCount > 0)
        {
            anemonePollenFlightHoldPoint.GetChild(0).gameObject.SetActive(false);
        }

        // ─── MOVE FOXGLOVE POLLEN TO FLIGHT ───────────────────────
        ...
        else if (foxglovePollenFlightHoldPoint.childCount > 0)
        {
            foxglovePollenFlightHoldPoint.GetChild(0).gameObject.SetActive(false);
        }
   ...
   void Dismount(bool jumpOff)
    {
       ...
       // ─── RETURN ANEMONE POLLEN TO GROUND ─────────────────────
        if (anemonePollenFlightHoldPoint.childCount > 0)
        {
            ...
            icon.localPosition = Vector3.zero;
            icon.localRotation = Quaternion.identity;
            icon.gameObject.SetActive(false); // hide it after dismount
        }
        else if (anemonePollenGroundHoldPoint.childCount > 0)
        {
            anemonePollenGroundHoldPoint.GetChild(0).gameObject.SetActive(false);
        }

        // ─── RETURN FOXGLOVE POLLEN TO GROUND ────────────────────
        ...
        else if (foxglovePollenGroundHoldPoint.childCount > 0)
        {
            foxglovePollenGroundHoldPoint.GetChild(0).gameObject.SetActive(false);
        }
