...
public class FlowerInteractionManager : MonoBehaviour
{
    ...
    void Update()
    {
        // --- Teapot logic (highest priority) ---
        if (teapotReceiver != null)
        {
            if (Input.GetKeyDown(KeyCode.X))
            {
                // if empty‑handed and pot has stuff → retrieve
    ...
    private void TryPickUpFromGarden()
    {
        ...
        // Clear prior garden parent if needed
    ...
    {
        // mirror Enter so nothing ever goes stale
