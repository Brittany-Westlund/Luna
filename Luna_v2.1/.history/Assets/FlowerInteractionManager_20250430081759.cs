...
public class FlowerInteractionManager : MonoBehaviour
{
    ...
    private void TryPlantToGarden()
    {
        ...
        // Set parent without preserving world transform
        held.transform.SetParent(currentGarden.transform, false);

        // Set transform manually to match planting point
        held.transform.localPosition = currentGarden.GetPlantingPoint().localPosition;
