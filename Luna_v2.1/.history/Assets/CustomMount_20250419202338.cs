...
{
    [Header("References")]
    public GameObject luna;                        // Single Luna object
    public Transform butterfly;                    // Butterfly mount transform
    public Transform lunaFlightAttachPoint;        // Where Luna sits while flying
    ...
    void Update()
    {
        ...
        // R: always spawn + auto-destroy; extend only when allowed
    ...
    void Dismount(bool jumpOff)
    {
        ...
        // Reattach spore point to ground
        _spore.attachPoint = sporeHoldPoint;
    }
