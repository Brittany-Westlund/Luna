...
public class FlowerInteractionManager : MonoBehaviour
{
    ...
    private void TryPickUpFromGarden()
    {
        ...
        // if it was planted, clear that GardenSpot’s record
    ...
    private void TryPlantToGarden()
    {
        ...
        // only swap if that spot truly had this flower
        if (swapped == held) swapped = null;

        // also check any pre‑placed child under this garden
        if (swapped == null)
        {
