...
public class SproutAndLightManager : MonoBehaviour
{
    ...
    // Static owners so only one icon shows at a time
    ...
    /// <summary>Called externally when Luna applies a spore.</summary>
    ...
    IEnumerator GrowStage()
    {
        ...
        // Compute absolute cap and target scale for this stage
        float baseX     = _initialScale.x;
        float maxScaleX = baseX + growthIncrement * maxGrowthStages;
        float targetX   = Mathf.Min(baseX + growthIncrement * _currentStage, maxScaleX);
        ...
        // Fully grown? spawn the light hint
    ...
    void ShowSporeHint()
    {
        ...
        // Hide any other flower's spore hint
    ...
    void ShowLightHint()
    {
        ...
        // Hide any other flower's light hint
    ...
    /// <summary>Called externally when Luna lights the flower.</summary>
