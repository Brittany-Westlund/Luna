...
public class FollowAndFlip : MonoBehaviour
{
    ...
    public float lowerDistance    = 0.3f;
    ...
    void Awake()
    {
        // remember the magnitude of your starting X scale
    ...
    void Update()
    {
        ...
        {
            FollowLuna();
            FaceTarget();    // always face toward Luna
        }
    }
    ...
    {
        isFollowing = false;
        // snap down instantly instead of lerping
        transform.position = new Vector3(
            transform.position.x,
            target.position.y + lowerDistance,
    ...
    {
        Vector3 goal = new Vector3(transform.position.x, transform.position.y - lowerDistance, transform.position.z);
    ...
    // Optional collision‐based facing when Luna walks up
