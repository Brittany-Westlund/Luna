       ...
       IEnumerator ReenableFollowNextFrame()
        {
            ...
            // Force it into the "stopped" state so your very next Z starts a fresh follow
            followAndFlip.SetFollow(false);

            // Also make sure no old lowering coroutine is still running
            StopAllCoroutines();    // if you have any lingering ones on this script
        }
