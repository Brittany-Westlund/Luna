...
public class TeacupInventory : MonoBehaviour
{
    ...
    public void DrinkTeacup()
    {
        ...
        // Play SFX before destroying the teacup
        var sfx = currentTeacup.GetComponent<TeacupDrinkSFX>();
        if (sfx != null) sfx.PlayDrinkSFX();

        float destroyDelay = 0.5f;
        if (sfx != null && sfx.drinkAudioSource != null && sfx.drinkAudioSource.clip != null)
            destroyDelay = sfx.drinkAudioSource.clip.length;
