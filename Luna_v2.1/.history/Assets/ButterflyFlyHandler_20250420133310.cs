...
public class ButterflyFlyHandler : MonoBehaviour
{
    ...
    public Transform groundFlowerHoldPoint;    // set this in the Inspector to your normal holdPoint
    public Transform flightFlowerHoldPoint;    // set this to wherever you want the flower to sit in flight
    ...
    void Mount()
    {
        ...
        // disable LunaSporeSystem so it won’t spawn a second spore
    ...
    void Dismount(bool jumpOff)
    {
       ...
       // back to normal spore behavior
        _spore.enabled = true;
        _spore.attachPoint = sporeHoldPoint;

        // restore the ground holdPoint
